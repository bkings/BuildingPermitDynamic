    ...
    <form method='POST' id='dataFrom'> 
        <div class="row">
            ...
            <div class='col-lg-2 col-sm-2 col-md-2 col-xs-6'>
                ...
                <input type='number' name='groupPosition' id='groupPosition' class='form-control'/>
            </div>
            <div class='col-lg-2 col-sm-2 col-md-2 col-xs-6'>
...
</fieldset>  <br> <fieldset>  <legend>Form Group Master Data</legend> 
    <div class='row' id='table'></div>
</fieldset>
<script>
    function edit(sn) {
        var id = ['id', 'name', 'groupPosition'];
...
<script>
    ...
    function doUpdate()
    {
        ...
        var URL = "<%=path%>/api/Utility/FormGroupMaster/" + document.getElementById('id').value;
...
<tr><th hidden>Id</th><th>Name</th><th>Position</th><th>Action</th></tr></thead><tbody></tbody></table>`;
                var tableData;
                for (var i = 0; i < data.length; i++)
                {
                    tableData = "<tr><td hidden>" + data[i].id + "</td><td>" + data[i].name + "</td><td>" + data[i].groupPosition + "</td><td><a onclick='edit(" + (i + 1) + ")' class='glyphicon glyphicon-edit'></a> | <a onclick='recordDelete(" + data[i].id + ")' class='glyphicon glyphicon-remove-circle'></a></td></tr>";
    ...
    function recordDelete(id) {
        if (!confirm('Are you sure'))
            return;
        var URL = "<%=path%>/api/Utility/FormGroupMaster/" + id;
        callApi(URL, "", "DELETE");
    }
    getRecord();
</script>
