...
<%@include file="../login/header.jsp"%>
        <fieldset>  <legend>Architectural Design C</legend> 
...
</fieldset>  <br> <fieldset>  <legend>ArchitecturalDesignCMaster Data</legend> 
...
var URL="<%=path%>/api/Utility/ArchitecturalDesignCMaster";
callApi(URL,requestData,"POST");
}
 function doUpdate()
{
  var dataForm = $('form').serializeArray(); var requestData = {}; $.each(dataForm, function(i, v) {requestData[v.name] = v.value;});
 var URL="<%=path%>/api/Utility/ArchitecturalDesignCMaster/1";
...
var URL="<%=path%>/api/Utility/ArchitecturalDesignCMaster/"+id;
callApi(URL,"","DELETE");
}
 getRecord();
</script>
