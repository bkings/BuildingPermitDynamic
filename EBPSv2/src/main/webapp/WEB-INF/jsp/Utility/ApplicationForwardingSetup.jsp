...
<fieldset>
	<legend>ApplicationForwardingSetup</legend>
	<form method='POST' id='dataFrom'>
		<div class="row">
			...
			<div class='col-lg-2 col-sm-2 col-md-2 col-xs-6'>
				<label>form Group</label> <select name='formGroup' id='formGroup'
					class='form-control' onchange="getRecord(this.value)"></select>

			</div>
			<div class='col-lg-2 col-sm-2 col-md-2 col-xs-6'>
				<label>Forward By</label> <select name='forwardBy' id='forwardBy'
			...
			<div class='col-lg-2 col-sm-2 col-md-2 col-xs-6'>
				<label>Forward To</label> <select name='forwardTo' id='forwardTo'
					class='form-control userType'>
					<option value="D">Designer</option>
					<option value="B">Sub Engineer</option>
					<option value="A">Engineer</option>
...
<br>
<fieldset>
	<legend>ApplicationForwardingSetup Data</legend>
