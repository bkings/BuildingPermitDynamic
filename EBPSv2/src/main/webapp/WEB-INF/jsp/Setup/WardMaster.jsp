...
<%@include file="../login/header.jsp"%>
        <fieldset>  <legend>WardMaster</legend> 
...
</fieldset>  <br> <fieldset>  <legend>WardMaster Data</legend> 
...
var URL="<%=path%>/api/Setup/WardMaster";
callApi(URL,requestData,"POST");
}
 function doUpdate()
{
  var dataForm = $('form').serializeArray(); var requestData = {}; $.each(dataForm, function(i, v) {requestData[v.name] = v.value;});
 var URL="<%=path%>/api/Setup/WardMaster/"+document.getElementById('id').value;
...
var URL="<%=path%>/api/Setup/WardMaster/"+id;
callApi(URL,"","DELETE");
}
 getRecord();
</script>
