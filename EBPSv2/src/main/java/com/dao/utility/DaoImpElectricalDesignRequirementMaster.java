...
@Component
public class DaoImpElectricalDesignRequirementMaster implements DaoElectricalDesignRequirementMaster {
    ...
    public List<ElectricalDesignRequirementMaster> getAll(String hql) {
        ...
        List<ElectricalDesignRequirementMaster> list = new ArrayList<>();
