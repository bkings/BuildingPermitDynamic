...
import com.service.processing.NoteorderPilengthLevelService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/NoteorderPilengthLevel")
public class NoteorderPilengthLevelRestController {
 @Autowired
 NoteorderPilengthLevelService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    NoteorderPilengthLevel obj = new NoteorderPilengthLevel();
