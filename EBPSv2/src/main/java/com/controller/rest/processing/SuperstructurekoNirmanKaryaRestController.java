...
import com.service.processing.SuperstructurekoNirmanKaryaService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/SuperstructurekoNirmanKarya")
public class SuperstructurekoNirmanKaryaRestController {
@Autowired
SuperstructurekoNirmanKaryaService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    SuperstructurekoNirmanKarya obj = new SuperstructurekoNirmanKarya();
