...
import com.service.processing.LandAreaCalculationService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/LandAreaCalculation")
public class LandAreaCalculationRestController {

	@Autowired
	LandAreaCalculationService service;
	...
	public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
		LandAreaCalculation obj = new LandAreaCalculation();
