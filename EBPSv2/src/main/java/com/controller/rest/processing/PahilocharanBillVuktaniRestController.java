...
@RestController
@CrossOrigin
@RequestMapping("api/Processing/PahilocharanBillVuktani")
public class PahilocharanBillVuktaniRestController {
	@Autowired
	PahilocharanBillVuktaniService service;
	...
	public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData,
			@RequestHeader(value = "Authorization") String Authorization) {

		PahilocharanBillVuktani obj = new PahilocharanBillVuktani();
