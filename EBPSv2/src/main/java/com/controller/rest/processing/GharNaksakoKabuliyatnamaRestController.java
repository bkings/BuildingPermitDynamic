...
import com.service.processing.GharNaksakoKabuliyatnamaService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/GharNaksakoKabuliyatnama")
public class GharNaksakoKabuliyatnamaRestController {
    
    @Autowired
    GharNaksakoKabuliyatnamaService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        ...
        GharNaksakoKabuliyatnama obj = new GharNaksakoKabuliyatnama();
