...
import com.service.processing.PuranoGharNirmanTippaniService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/PuranoGharNirmanTippani")

public class PuranoGharNirmanTippaniRestController {
@Autowired
PuranoGharNirmanTippaniService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    PuranoGharNirmanTippani obj = new PuranoGharNirmanTippani();
