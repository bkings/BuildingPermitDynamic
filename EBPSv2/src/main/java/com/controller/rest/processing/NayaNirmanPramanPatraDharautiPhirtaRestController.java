...
import com.service.processing.NayaNirmanPramanPatraDharautiPhirtaService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/NayaNirmanPramanPatraDharautiPhirta")
public class NayaNirmanPramanPatraDharautiPhirtaRestController {

    @Autowired
    NayaNirmanPramanPatraDharautiPhirtaService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        NayaNirmanPramanPatraDharautiPhirta obj = new NayaNirmanPramanPatraDharautiPhirta();
