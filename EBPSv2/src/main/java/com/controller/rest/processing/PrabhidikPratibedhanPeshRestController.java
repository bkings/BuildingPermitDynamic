...
import com.service.processing.PrabhidikPratibedhanPeshService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/PrabhidikPratibedhanPesh")
public class PrabhidikPratibedhanPeshRestController {

@Autowired
PrabhidikPratibedhanPeshService service;
...
public Object doSave(@PathVariable Long applicationNo,@PathVariable String hasRevised, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    PrabhidikPratibedhanPesh obj = new PrabhidikPratibedhanPesh();
