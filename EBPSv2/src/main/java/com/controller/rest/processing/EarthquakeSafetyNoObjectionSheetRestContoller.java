...
import com.service.processing.EarthquakeSafetyNoObjectionSheetService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/EarthquakeSafetyNoObjectionSheet")
public class EarthquakeSafetyNoObjectionSheetRestContoller {

	@Autowired
	EarthquakeSafetyNoObjectionSheetService service;
	...
	public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
		EarthquakeSafetyNoObjectionSheet obj = new EarthquakeSafetyNoObjectionSheet();
