...
import com.service.processing.LayoutGariPratibedanRequestService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/LayoutGariPratibedanRequest")
public class LayoutGariPratibedanRequestRestController {
    @Autowired
    LayoutGariPratibedanRequestService service;
   @GetMapping("/{id}")
    ...
    public Object doSave(@PathVariable long id, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) throws IOException {
        LayoutGariPratibedanRequest obj = new LayoutGariPratibedanRequest();
