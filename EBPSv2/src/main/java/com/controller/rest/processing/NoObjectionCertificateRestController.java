...
import com.service.processing.NoObjectionCertificateService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/Phase1/NoObjectionCertificate")
public class NoObjectionCertificateRestController {

	model.Message message = new model.Message();
	String msg = "", sql;
	int row;
	@Autowired
	NoObjectionCertificateService service;
