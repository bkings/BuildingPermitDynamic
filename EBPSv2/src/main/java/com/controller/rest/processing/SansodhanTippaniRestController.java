...
import com.service.processing.SansodhanTippaniService;

@RestController     
@CrossOrigin
@RequestMapping("api/Processing/SansodhanTippani")
public class SansodhanTippaniRestController {
    
@Autowired
SansodhanTippaniService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    SansodhanTippani obj = new SansodhanTippani();
