...
import com.service.processing.NirmanSampannaPramanPatraAndDharautiFirtaService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/NirmanSampannaPramanPatraAndDharautiFirta")
public class NirmanSampannaPramanPatraAndDharautiFirtaRestController {

	@Autowired
	NirmanSampannaPramanPatraAndDharautiFirtaService service;
	...
	public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
		NirmanSampannaPramanPatraAndDharautiFirta obj = new NirmanSampannaPramanPatraAndDharautiFirta();
