...
import com.service.processing.SuperstructurekoTippaniadeshService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/SuperstructurekoTippaniadesh")
public class SuperstructurekoTippaniadeshRestController {
              
@Autowired
SuperstructurekoTippaniadeshService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    SuperstructurekoTippaniadesh obj = new SuperstructurekoTippaniadesh();
