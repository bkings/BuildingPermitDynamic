...
import com.service.processing.DharautiPhirtaBareService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/DharautiPhirtaBare")
public class DharautiPhirtaBareRestController {

    @Autowired
    DharautiPhirtaBareService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        DharautiPhirtaBare obj = new DharautiPhirtaBare();
