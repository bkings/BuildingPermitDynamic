...
import com.service.processing.SthalgatNiirikshyanGariPeshService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/Phase1/SthalgatNiirikshyanGariPesh")
public class SthalgatNiirikshyanGariPeshRestController {

	model.Message message = new model.Message();
	String msg = "", sql;
	int row;
	@Autowired
	SthalgatNiirikshyanGariPeshService service;
