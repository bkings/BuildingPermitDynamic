...
import com.service.processing.ManjurinamaService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/Manjurinama")
public class ManjurinamaRestController {

    @Autowired
    ManjurinamaService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        Manjurinama obj = new Manjurinama();
