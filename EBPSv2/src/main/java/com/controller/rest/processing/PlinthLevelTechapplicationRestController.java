...
import com.service.processing.PlinthLevelTechapplicationService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/PlinthLevelTechapplication")
public class PlinthLevelTechapplicationRestController {
    
    @Autowired  
    PlinthLevelTechapplicationService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    PlinthLevelTechapplication obj = new PlinthLevelTechapplication();
