...
import com.service.processing.SansodhankoTippaniAdeshService;

@RestController     
@CrossOrigin
@RequestMapping("api/Processing/SansodhankoTippaniAdesh")
public class SansodhankoTippaniAdeshRestController {
    
@Autowired
SansodhankoTippaniAdeshService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    SansodhankoTippaniAdesh obj = new SansodhankoTippaniAdesh();
