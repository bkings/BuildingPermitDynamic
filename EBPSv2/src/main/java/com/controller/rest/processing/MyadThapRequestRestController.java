...
import com.service.processing.MyadThapRequestService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/MyadThapRequest")
public class MyadThapRequestRestController {

    @Autowired
    MyadThapRequestService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        MyadThapRequest obj = new MyadThapRequest();
