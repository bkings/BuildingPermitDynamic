...
import com.service.processing.AllowancePaperService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/AllowancePaper")
public class AllowancePaperRestController {
    
@Autowired
AllowancePaperService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    AllowancePaper obj = new AllowancePaper();
