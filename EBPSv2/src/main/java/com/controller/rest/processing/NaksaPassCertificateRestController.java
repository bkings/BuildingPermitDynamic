...
import com.service.processing.NaksaPassCertificateService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/NaksaPassCertificate")
public class NaksaPassCertificateRestController {

	@Autowired
	NaksaPassCertificateService service;
	...
	public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
		NaksaPassCertificate obj = new NaksaPassCertificate();
