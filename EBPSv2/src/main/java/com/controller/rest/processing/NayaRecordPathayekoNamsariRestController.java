...
import com.service.processing.NayaRecordPathayekoNamsariService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/NayaRecordPathayekoNamsari")
public class NayaRecordPathayekoNamsariRestController {

    @Autowired
    NayaRecordPathayekoNamsariService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        NayaRecordPathayekoNamsari obj = new NayaRecordPathayekoNamsari();
