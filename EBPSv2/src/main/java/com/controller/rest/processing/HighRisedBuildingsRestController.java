...
import com.service.processing.HighRisedBuildingsService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/HighRisedBuildings")
public class HighRisedBuildingsRestController {

	@Autowired
	HighRisedBuildingsService service;
	...
	public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
		HighRisedBuildings obj = new HighRisedBuildings();
