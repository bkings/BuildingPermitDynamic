...
import com.service.processing.ArchitecturalDesignBService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/Phase1/ArchitecturalDesignClassB")
public class ADRCBRestController {
    ...
    @Autowired
    ArchitecturalDesignBService service;
