...
import com.service.processing.SansodhanGariNibedanService;

@RestController     
@CrossOrigin
@RequestMapping("api/Processing/SansodhanGariNibedan")
public class SansodhanGariNibedanRestController {
    
@Autowired
SansodhanGariNibedanService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    SansodhanGariNibedan obj = new SansodhanGariNibedan();
