...
import com.service.processing.ArchitecturalDesignCService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/Phase1/ArchitecturalDesignClassC")
public class ADRCCRestController {
...
@Autowired
ArchitecturalDesignCService service;
