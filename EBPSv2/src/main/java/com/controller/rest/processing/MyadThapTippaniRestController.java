...
import com.service.processing.MyadThapTippaniService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/MyadThapTippani")
public class MyadThapTippaniRestController {

    @Autowired
    MyadThapTippaniService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        MyadThapTippani obj = new MyadThapTippani();
