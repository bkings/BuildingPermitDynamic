...
import com.service.processing.SansodhanBibaranPahiloService;

@RestController     
@CrossOrigin
@RequestMapping("api/Processing/SansodhanBibaranPahilo")
public class SansodhanBibaranPahiloRestController {
    
@Autowired
 SansodhanBibaranPahiloService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
     ...
     SansodhanBibaranPahilo obj = new  SansodhanBibaranPahilo();
