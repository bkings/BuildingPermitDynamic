...
import com.service.processing.WaresnamaService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/Waresnama")
public class WaresnamaRestController {

    @Autowired
    WaresnamaService service;
