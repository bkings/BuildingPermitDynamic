...
import com.service.processing.SanitaryDesignService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/Phase1/SanitaryDesign")
public class SanitaryDesignRestController {

@Autowired
SanitaryDesignService service;
