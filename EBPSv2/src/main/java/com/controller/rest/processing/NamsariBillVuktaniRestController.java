...
import com.service.processing.NamsariBillVuktaniService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/NamsariBillVuktani")

public class NamsariBillVuktaniRestController {

    @Autowired
    NamsariBillVuktaniService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        ...
        NamsariBillVuktani obj = new NamsariBillVuktani();
