...
import com.service.processing.PratibeydanPeshGarekoBareService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/PratibeydanPeshGarekoBare")
public class PratibeydanPeshGarekoBareRestController {

	@Autowired
	PratibeydanPeshGarekoBareService service;
	...
	public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
		PratibeydanPeshGarekoBare obj = new PratibeydanPeshGarekoBare();
