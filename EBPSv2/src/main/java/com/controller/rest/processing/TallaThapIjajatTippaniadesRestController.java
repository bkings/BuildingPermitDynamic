...
import com.service.processing.TallaThapIjajatTippaniadesService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/TallaThapIjajatTippaniades")
public class TallaThapIjajatTippaniadesRestController {

    @Autowired
    TallaThapIjajatTippaniadesService service;
    ...
    public Object doSave(@PathVariable long id, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) throws IOException {
        TallaThapIjajatTippaniades obj = new TallaThapIjajatTippaniades();
