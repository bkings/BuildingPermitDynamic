...
import com.service.processing.LayoutGariPratibedanIjajatService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/LayoutGariPratibedanIjajat")
public class LayoutGariPratibedanIjajatRestController {
    @Autowired
    LayoutGariPratibedanIjajatService service;
   @GetMapping("/{id}")
    ...
    public Object doSave(@PathVariable long id, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) throws IOException {
        LayoutGariPratibedanIjajat obj = new LayoutGariPratibedanIjajat();
