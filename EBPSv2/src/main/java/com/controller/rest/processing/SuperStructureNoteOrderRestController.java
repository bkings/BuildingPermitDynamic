...
import com.service.processing.SuperStructureNoteOrderService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/SuperStructureNoteOrder")
public class SuperStructureNoteOrderRestController {

    @Autowired
    SuperStructureNoteOrderService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        ...
        SuperStructureNoteOrder obj = new SuperStructureNoteOrder();
