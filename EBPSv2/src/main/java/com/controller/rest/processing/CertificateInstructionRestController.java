...
import com.service.processing.CertificateInstructionService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/CertificateInstruction")
public class CertificateInstructionRestController {
    
@Autowired
CertificateInstructionService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    CertificateInstruction obj = new CertificateInstruction();
