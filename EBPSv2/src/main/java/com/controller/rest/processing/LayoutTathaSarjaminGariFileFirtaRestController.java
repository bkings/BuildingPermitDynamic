...
import com.service.processing.LayoutTathaSarjaminGariFileFirtaService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/LayoutTathaSarjaminGariFileFirta")
public class LayoutTathaSarjaminGariFileFirtaRestController {

	@Autowired
	LayoutTathaSarjaminGariFileFirtaService service;
	...
	public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
		LayoutTathaSarjaminGariFileFirta obj = new LayoutTathaSarjaminGariFileFirta();
