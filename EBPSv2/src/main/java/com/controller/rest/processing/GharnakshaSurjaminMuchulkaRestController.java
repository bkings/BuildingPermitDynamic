...
import com.service.processing.GharnakshaSurjaminMuchulkaService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/GharnakshaSurjaminMuchulka")
public class GharnakshaSurjaminMuchulkaRestController {

    @Autowired
    GharnakshaSurjaminMuchulkaService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        GharnakshaSurjaminMuchulka obj = new GharnakshaSurjaminMuchulka();
