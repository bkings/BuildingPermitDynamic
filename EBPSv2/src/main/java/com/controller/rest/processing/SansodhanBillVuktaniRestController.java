...
@RestController
@CrossOrigin
@RequestMapping("api/Processing/SansodhanBillVuktani")
public class SansodhanBillVuktaniRestController {
@Autowired
SansodhanBillVuktaniService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    SansodhanBillVuktani obj = new SansodhanBillVuktani();
