...
import com.service.processing.DosrocharanPrabidhikService;



@RestController
@CrossOrigin
@RequestMapping("api/Processing/DosrocharanPrabidhik")
public class DosrocharanPrabidhikRestController {
    
@Autowired
DosrocharanPrabidhikService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    DosrocharanPrabidhik obj = new DosrocharanPrabidhik();
