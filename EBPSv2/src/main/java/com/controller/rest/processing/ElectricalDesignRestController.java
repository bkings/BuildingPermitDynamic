...
import com.service.processing.ElectricalDesignService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/Phase1/ElectricalDesign")
public class ElectricalDesignRestController {

model.Message message = new model.Message();
String msg = "", sql;
int row;
@Autowired
ElectricalDesignService service;
