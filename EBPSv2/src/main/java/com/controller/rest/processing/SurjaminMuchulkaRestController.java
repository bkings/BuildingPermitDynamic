...
import com.service.processing.SurjaminMuchulkaService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/SurjaminMuchulka")
public class SurjaminMuchulkaRestController {

    @Autowired
    SurjaminMuchulkaService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        SurjaminMuchulka obj = new SurjaminMuchulka();
