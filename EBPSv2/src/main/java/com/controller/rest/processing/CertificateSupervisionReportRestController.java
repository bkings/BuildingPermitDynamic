...
import com.service.processing.CertificateSupervisionReportService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/CertificateSupervisionReport")
public class CertificateSupervisionReportRestController {

	@Autowired
	CertificateSupervisionReportService service;
	...
	public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
		CertificateSupervisionReport obj = new CertificateSupervisionReport();  
