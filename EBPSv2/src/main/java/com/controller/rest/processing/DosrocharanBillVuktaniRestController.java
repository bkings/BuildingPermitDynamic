...
@RestController
@CrossOrigin
@RequestMapping("api/Processing/DosrocharanBillVuktani")
public class DosrocharanBillVuktaniRestController {
    
@Autowired
DosrocharanBillVuktaniService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    DosrocharanBillVuktani obj = new DosrocharanBillVuktani();
