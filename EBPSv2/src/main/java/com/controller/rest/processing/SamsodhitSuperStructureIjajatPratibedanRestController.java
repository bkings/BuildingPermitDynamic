...
import com.service.processing.SamsodhitSuperStructureIjajatPratibedanService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/SamsodhitSuperStructureIjajatPratibedan")
public class SamsodhitSuperStructureIjajatPratibedanRestController {
    
    @Autowired
    SamsodhitSuperStructureIjajatPratibedanService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        ...
        SamsodhitSuperStructureIjajatPratibedan obj = new SamsodhitSuperStructureIjajatPratibedan();
