...
import com.service.processing.AminKoSthalgatPratibedanService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/AminKoSthalgatPratibedan")
public class AminKoSthalgatPratibedanRestController {

    @Autowired
    AminKoSthalgatPratibedanService service;
    ...
    public Object doSave(@PathVariable long id, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) throws IOException {
        AminKoSthalgatPratibedan obj = new AminKoSthalgatPratibedan();
