...
import com.service.processing.KabuliyatnamaService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/Kabuliyatnama")
public class KabuliyatnamaRestController {

    @Autowired
    KabuliyatnamaService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        ...
        Kabuliyatnama obj = new Kabuliyatnama();
