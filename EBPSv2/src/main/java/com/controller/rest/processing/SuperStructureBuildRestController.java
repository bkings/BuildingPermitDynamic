...
import com.service.processing.SuperStructureBuildService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/SuperStructureBuild")
public class SuperStructureBuildRestController {

@Autowired
SuperStructureBuildService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    SuperStructureBuild obj = new SuperStructureBuild();
