...
import com.service.processing.StructureDesignBService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/Phase1/StructureDesignB")
public class StructureDesignBRestController {

@Autowired
StructureDesignBService service;
