...
import com.service.processing.SansodhansuperTippaniAdeshService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/SansodhansuperTippaniAdesh")
public class SansodhansuperTippaniAdeshRestController {
    
    @Autowired
    SansodhansuperTippaniAdeshService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        ...
        SansodhansuperTippaniAdesh obj = new SansodhansuperTippaniAdesh();
