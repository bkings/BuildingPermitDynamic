...
import com.service.processing.GharCompoundwallkoNaapService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/GharCompoundwallkoNaap")
public class GharCompoundwallkoNaapRestController {
    
@Autowired
GharCompoundwallkoNaapService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    GharCompoundwallkoNaap obj = new GharCompoundwallkoNaap();
