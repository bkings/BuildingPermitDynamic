...
import com.service.processing.KaryalayaPrayojan15DaysNoticeService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/KaryalayaPrayojan15DaysNotice")
public class KaryalayaPrayojan15DaysNoticeRestController {
	
	@Autowired
	KaryalayaPrayojan15DaysNoticeService service;
	...
	public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
		KaryalayaPrayojan15DaysNotice obj = new KaryalayaPrayojan15DaysNotice();
