...
import com.service.processing.SansodhanSuperStructureIjjaatService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/SansodhanSuperStructureIjjaat")
public class SansodhanSuperStructureIjjaatRestController {
    
    @Autowired
    SansodhanSuperStructureIjjaatService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        ...
        SansodhanSuperStructureIjjaat obj = new SansodhanSuperStructureIjjaat();
