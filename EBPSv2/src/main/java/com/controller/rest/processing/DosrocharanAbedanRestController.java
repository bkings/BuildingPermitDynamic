...
import com.service.processing.DosrocharanAbedanService;


@RestController
@CrossOrigin
@RequestMapping("api/Processing/DosrocharanAbedan")
public class DosrocharanAbedanRestController {
    
@Autowired
DosrocharanAbedanService service;
...
public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
    ...
    DosrocharanAbedan obj = new DosrocharanAbedan();
