...
import com.service.processing.DharautiPhirtaTippaniAdesService;

@RestController
@CrossOrigin
@RequestMapping("api/Processing/DharautiPhirtaTippaniAdes")
public class DharautiPhirtaTippaniAdesRestController {

    @Autowired
    DharautiPhirtaTippaniAdesService service;
    ...
    public Object doSave(@PathVariable Long applicationNo, @RequestBody String jsonData, @RequestHeader(value = "Authorization") String Authorization) {
        DharautiPhirtaTippaniAdes obj = new DharautiPhirtaTippaniAdes();
