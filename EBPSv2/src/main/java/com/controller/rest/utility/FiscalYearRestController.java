...
import com.service.utility.FiscalYearService;

@RestController
@RequestMapping("api/Utility/FiscalYear")
@CrossOrigin
public class FiscalYearRestController {
    ...
    @PostMapping
    public Object doSave(@RequestBody FiscalYear obj, @RequestHeader(value = "Authorization") String Authorization) throws IOException {
        return service.save(obj, Authorization);
    }

    @PutMapping("/{id}")
    public Object doUpdate(@RequestBody FiscalYear obj, @PathVariable long id, @RequestHeader(value = "Authorization") String Authorization) throws IOException {
