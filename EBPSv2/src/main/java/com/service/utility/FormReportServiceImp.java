...
//        sql = "SELECT json_data AS \"jsonData\" FROM rajaswa_entry E,rajaswa_voucher V,building_permit_application B WHERE V.application_no=B.id AND E.application_no=V.application_no AND (V.amini_status='A' OR V.rw_status='A' OR V.ser_status='A' OR V.er_status='A' OR V.chief_status='A' ) AND B.applicant_date BETWEEN '" + startDate + "' AND '" + endDate + "' " + designer + NEW_WARD_NO + constructionType;
        sql = "SELECT json_data AS \"jsonData\" FROM rajaswa_entry E,rajaswa_voucher V,building_permit_application B,status S WHERE V.application_no=B.id AND E.application_no=V.application_no AND S.application_no=E.application_no AND S.application_no=V.application_no AND (S.form_id=(SELECT id from form_name_master WHERE table_id=(SELECT id from ebps_tables WHERE table_name='rajaswa_voucher')) AND (S.user_type in ('AD','R','B','A','C'))) AND B.applicant_date BETWEEN '" + startDate + "' AND '" + endDate + "' " + designer + NEW_WARD_NO + constructionType;
...
//        sql = " SELECT json_data AS \"jsonData\" FROM pahilocharan_bill_vuktani V,building_permit_application B WHERE V.application_no=B.id AND (V.amini_status='A' OR V.rw_status='A' OR V.ser_status='A' OR V.er_status='A' OR V.chief_status='A' ) AND B.applicant_date BETWEEN '" + startDate + "' AND '" + endDate + "' " + designer + NEW_WARD_NO + constructionType;
        sql = " SELECT json_data AS \"jsonData\" FROM pahilocharan_bill_vuktani V,building_permit_application B,status S WHERE V.application_no=B.id AND S.application_no=V.application_no AND (S.form_id=(SELECT id from form_name_master WHERE table_id=(SELECT id from ebps_tables WHERE table_name='pahilocharan_bill_vuktani')) AND (S.user_type in ('AD','R','B','A','C'))) AND B.applicant_date BETWEEN '" + startDate + "' AND '" + endDate + "' " + designer + NEW_WARD_NO + constructionType;
...
//        sql = "SELECT json_data AS \"jsonData\" FROM dosrocharan_bill_vuktani V,building_permit_application B WHERE V.application_no=B.id AND (V.amini_status='A' OR V.rw_status='A' OR V.ser_status='A' OR V.er_status='A' OR V.chief_status='A' ) AND B.applicant_date BETWEEN '" + startDate + "' AND '" + endDate + "' " + designer + NEW_WARD_NO + constructionType;
        sql = " SELECT json_data AS \"jsonData\" FROM dosrocharan_bill_vuktani V,building_permit_application B,status S WHERE V.application_no=B.id AND S.application_no=V.application_no AND (S.form_id=(SELECT id from form_name_master WHERE table_id=(SELECT id from ebps_tables WHERE table_name='dosrocharan_bill_vuktani')) AND (S.user_type in ('AD','R','B','A','C'))) AND B.applicant_date BETWEEN '" + startDate + "' AND '" + endDate + "' " + designer + NEW_WARD_NO + constructionType;
...
//        sql = " SELECT json_data AS \"jsonData\" FROM namsari_bill_vuktani V,building_permit_application B WHERE V.application_no=B.id AND (V.amini_status='A' OR V.rw_status='A' OR V.ser_status='A' OR V.er_status='A' OR V.chief_status='A') AND B.applicant_date BETWEEN '" + startDate + "' AND '" + endDate + "' " + designer + NEW_WARD_NO + constructionType;
        sql = " SELECT json_data AS \"jsonData\" FROM namsari_bill_vuktani V,building_permit_application B,status S WHERE V.application_no=B.id AND S.application_no=V.application_no AND (S.form_id=(SELECT id from form_name_master WHERE table_id=(SELECT id from ebps_tables WHERE table_name='namsari_bill_vuktani')) AND (S.user_type in ('AD','R','B','A','C'))) AND B.applicant_date BETWEEN '" + startDate + "' AND '" + endDate + "' " + designer + NEW_WARD_NO + constructionType;
...
//        sql = "SELECT json_data AS \"jsonData\" FROM sansodhan_bill_vuktani V,building_permit_application B WHERE V.application_no=B.id AND (V.amini_status='A' OR V.rw_status='A' OR V.ser_status='A' OR V.er_status='A' OR V.chief_status='A' ) AND B.applicant_date BETWEEN '" + startDate + "' AND '" + endDate + "' " + designer + NEW_WARD_NO + constructionType;
        sql = " SELECT json_data AS \"jsonData\" FROM sansodhan_bill_vuktani V,building_permit_application B,status S WHERE V.application_no=B.id AND S.application_no=V.application_no AND (S.form_id=(SELECT id from form_name_master WHERE table_id=(SELECT id from ebps_tables WHERE table_name='sansodhan_bill_vuktani')) AND (S.user_type in ('AD','R','B','A','C'))) AND B.applicant_date BETWEEN '" + startDate + "' AND '" + endDate + "' " + designer + NEW_WARD_NO + constructionType;
