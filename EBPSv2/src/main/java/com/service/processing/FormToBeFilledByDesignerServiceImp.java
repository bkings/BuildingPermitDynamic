...
@Service
public class FormToBeFilledByDesignerServiceImp implements FormToBeFilledByDesignerService {
	...
	public Object getAll(long applicationNo) {
		message.list = da.getAll("from FormToBeFilledByDesigner where applicationNo=" + applicationNo);
