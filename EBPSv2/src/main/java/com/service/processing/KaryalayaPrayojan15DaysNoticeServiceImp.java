...
@Service
public class KaryalayaPrayojan15DaysNoticeServiceImp implements KaryalayaPrayojan15DaysNoticeService {
	...
	public Object getAll(long applicationNo) {
		message.list = da.getAll("from KaryalayaPrayojan15DaysNotice where applicationNo=" + applicationNo);
