...
@Service
public class PrathamCharanKaamGarneAnumatiServiceImp implements PrathamCharanKaamGarneAnumatiService {
	...
	public Object getAll(long applicationNo) {
		message.list = da.getAll("from PrathamCharanKaamGarneAnumati where applicationNo=" + applicationNo);
