...
@Service
public class PratibeydanPeshGarekoBareServiceImp implements PratibeydanPeshGarekoBareService {
	...
	public Object getAll(long applicationNo) {
		message.list = da.getAll("from PratibeydanPeshGarekoBare where applicationNo=" + applicationNo);
