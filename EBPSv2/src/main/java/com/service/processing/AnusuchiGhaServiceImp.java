...
import com.dao.processing.DaoAnusuchiGha;
...
@Service
public class AnusuchiGhaServiceImp implements AnusuchiGhaService {
    ...
    public Object getAll(String Authorization, String applicationNo) {
        ...
        message.list = da.getAll("from AnusuchiGha where applicationNo='" + applicationNo + "'");
        ...
        ApplicationLog.save("api/Processing/Phase1/AnusuchiGha", "GET", td.getUserName(), "get the form");
        return message.map;
    }
    ...
    public Object save(AnusuchiGha obj, String Authorization) {
        ...
        sql = "SELECT ER_STATUS erstatus,SER_STATUS serstatus FROM anusuchi_gha WHERE APPLICATION_NO='" + applicationNo + "'";
        ...
        msg = da.getMsg();
        if (row == 1) {
            ApplicationLog.save("api/Processing/Phase1/AnusuchiGha", "POST", td.getUserName(), "save or update form");
    ...
    public Object doApprove(Long applicationNo, ApplicationApproved obj, String Authorization) {
        return new ApplicationApprove().doApprove(applicationNo, obj, Authorization, "10");
    }
}/*  
        JWTToken td = new JWTToken(Authorization);
        if (!td.isValid()) {
