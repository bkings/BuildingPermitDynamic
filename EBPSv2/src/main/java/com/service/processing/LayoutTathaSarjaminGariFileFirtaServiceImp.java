...
@Service
public class LayoutTathaSarjaminGariFileFirtaServiceImp implements LayoutTathaSarjaminGariFileFirtaService {
	@Autowired
	EBPSDao da;
	...
	public Object getAll(long applicationNo) {
		message.list = da.getAll("from LayoutTathaSarjaminGariFileFirta where applicationNo=" + applicationNo);
