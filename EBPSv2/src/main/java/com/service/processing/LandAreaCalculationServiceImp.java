...
@Service
public class LandAreaCalculationServiceImp implements LandAreaCalculationService {
	...
	public Object getAll(long applicationNo) {
		message.list = da.getAll("from LandAreaCalculation where applicationNo=" + applicationNo);
