...
@Service
public class GharCompoundWallServiceImp implements GharCompoundWallService {
    ...
    public Object getAll(long id) {
        message.list = da.getAll("from GharCompoundWall where applicationNo=" + id);
    ...
    public Object save(GharCompoundWall obj, String Authorization) {
        ...
        if (!message.checkSaveStatus(userType, "21", obj.getApplicationNo())) {
