...
@Service
public class SuchanaTaasGariMuchulkaServiceImp implements SuchanaTaasGariMuchulkaService {
	...
	public Object getAll(long applicationNo) {
		message.list = da.getAll("from SuchanaTaasGariMuchulka where applicationNo=" + applicationNo);
