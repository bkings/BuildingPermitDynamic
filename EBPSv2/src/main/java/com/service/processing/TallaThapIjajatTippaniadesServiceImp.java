...
import com.dao.processing.DaoTallaThapIjajatTippaniades;
import com.model.application.ApplicationApproved;
import com.model.processing.TallaThapIjajatTippaniades;

@Service
public class TallaThapIjajatTippaniadesServiceImp implements TallaThapIjajatTippaniadesService {

    @Autowired
    DaoTallaThapIjajatTippaniades da;
    ...
    public Object getAll(String Authorization, long id) {
        ...
        message.list = da.getAll("from TallaThapIjajatTippaniades where applicationNo=" + id);
        ...
        message.map.put("comment", message.getComment("" + id, "58"));
        message.map.put("history", message.getHistory(id, "58"));
        return message.map;
    }
    ...
    public Object save(TallaThapIjajatTippaniades obj, String Authorization) {
        ...
        if (!message.checkSaveStatus(userType, "58", applicationNo)) {
        ...
        try {
            row = da.save(obj);
            if (row == 1) {
                message.db.save(message.getEnterByStatus(userType, 58, applicationNo));
                message.setHistory(applicationNo, td.getUserType(), "58", "S", td.getUserName());
    ...
    public Object doApprove(Long applicationNo, ApplicationApproved obj, String Authorization) {
            return new ApplicationApprove().doApprove(applicationNo, obj, Authorization, "58");
    }
}