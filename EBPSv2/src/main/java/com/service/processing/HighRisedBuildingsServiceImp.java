...
@Service
public class HighRisedBuildingsServiceImp implements HighRisedBuildingsService {
	...
	public Object getAll(long applicationNo) {
		message.list = da.getAll("from HighRisedBuildings where applicationNo=" + applicationNo);
