...
@Service
public class PratibeydanSambandhamaServiceImp implements PratibeydanSambandhamaService {
	@Autowired
	EBPSDao da;
	...
	public Object getAll(long applicationNo) {
		message.list = da.getAll("from PratibeydanSambandhama where applicationNo=" + applicationNo);
