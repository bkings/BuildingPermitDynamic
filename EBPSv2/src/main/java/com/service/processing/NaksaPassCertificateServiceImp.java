...
@Service
public class NaksaPassCertificateServiceImp implements NaksaPassCertificateService {
	...
	public Object getAll(long applicationNo) {
		message.list = da.getAll("from NaksaPassCertificate where applicationNo=" + applicationNo);
