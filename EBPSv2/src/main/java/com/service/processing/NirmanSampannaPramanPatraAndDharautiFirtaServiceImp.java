...
@Service
public class NirmanSampannaPramanPatraAndDharautiFirtaServiceImp implements NirmanSampannaPramanPatraAndDharautiFirtaService {
	...
	public Object getAll(long applicationNo) {
		message.list = da.getAll("from NirmanSampannaPramanPatraAndDharautiFirta where applicationNo=" + applicationNo);
