...
@Entity
@Table(name = "sthalgat_nirikshyan_gari_pesh")
public class SthalgatNiirikshyanGariPesh implements Serializable {
	...
	public String toString() {
		return "SthalgatNiirikshyanGariPesh [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate
				+ ", aminiName=" + aminiName + ", aminiDate=" + aminiDate + ", aminiStatus=" + aminiStatus + ", serDate=" + serDate + ", serName=" + serName
				+ ", erName=" + erName + ", erDate=" + erDate + ", erStatus=" + erStatus + ", serStatus=" + serStatus + ", chiefName=" + chiefName
