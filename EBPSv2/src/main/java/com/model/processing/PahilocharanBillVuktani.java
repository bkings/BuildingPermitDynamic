...
@Entity
@Table(name = "pahilocharan_bill_vuktani")


public class PahilocharanBillVuktani implements Serializable {
@Id
...
@Column(name = "bill_submit", updatable = false)
private String bill_submit;
...
public void setChiefStatus(String chiefStatus) {
    ...
    public String getBill_submit() {
        return bill_submit;
    }

    public void setBill_submit(String bill_submit) {
        this.bill_submit = bill_submit;
    }

    @Override
    public String toString() {
        return "PahilocharanBillVuktani{" + "applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate + ", aminiName=" + aminiName + ", aminiDate=" + aminiDate + ", aminiStatus=" + aminiStatus + ", serDate=" + serDate + ", serName=" + serName + ", erName=" + erName + ", erDate=" + erDate + ", erStatus=" + erStatus + ", serStatus=" + serStatus + ", chiefName=" + chiefName + ", chiefDate=" + chiefDate + ", chiefStatus=" + chiefStatus + ", rwName=" + rwName + ", rwDate=" + rwDate + ", rwStatus=" + rwStatus + ", bill_submit=" + bill_submit + '}';
    }
