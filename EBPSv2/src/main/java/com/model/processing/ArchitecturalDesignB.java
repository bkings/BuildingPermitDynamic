...
@Entity
@Table(name = "architectural_design_b")
public class ArchitecturalDesignB implements Serializable {
...
public void setRwStatus(String rwStatus) {
    ...
    public String toString() {
        return "ArchitecturalDesignB{" + "applicationNo=" + applicationNo + ", buildingType=" + buildingType + ", enterBy=" + enterBy + ", enterDate=" + enterDate + ", serName=" + serName + ", serDate=" + serDate + ", serStatus=" + serStatus + ", erName=" + erName + ", erDate=" + erDate + ", erStatus=" + erStatus + ", chiefName=" + chiefName + ", chiefDate=" + chiefDate + ", chiefStatus=" + chiefStatus + ", aminiName=" + aminiName + ", aminiDate=" + aminiDate + ", aminiStatus=" + aminiStatus + ", rwName=" + rwName + ", rwDate=" + rwDate + ", rwStatus=" + rwStatus + '}';
    }
