...
@Entity
@Table(name = "architectural_design_c_details")
public class ArchitecturalDesignCDetails implements Serializable {
...
public ArchitecturalDesignCDetails() {
}
...
public void setRemark(String remark) {
    ...
    public String toString() {
        return "ArchitecturalDesignCDetails{" + "pk=" + pk + ", qty=" + qty + ", remark=" + remark + ", unit=" + unit + ", applicationNo=" + applicationNo + '}';
    }
