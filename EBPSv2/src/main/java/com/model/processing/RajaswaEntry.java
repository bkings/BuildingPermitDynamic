...
@Entity
@Table(name = "rajaswa_entry")
public class RajaswaEntry implements java.io.Serializable {
...
//    private BuildingPermitApplication buildingPermitApplication;
    ...
    public String toString() {
        return "\n{\"applicationNo\":\"" + applicationNo + "\",\"jsonData\":\"" + jsonData + "\",\"enterBy\":\"" + enterBy + "\",\"enterDate\":\"" + enterDate + "\",\"aminiName\":\"" + aminiName + "\",\"aminiDate\":\"" + aminiDate + "\",\"aminiStatus\":\"" + aminiStatus + "\",\"serDate\":\"" + serDate + "\",\"serName\":\"" + serName + "\",\"serStatus\":\"" + serStatus + "\",\"erName\":\"" + erName + "\",\"erDate\":\"" + erDate + "\",\"erStatus\":\"" + erStatus + "\",\"chiefName\":\"" + chiefName + "\",\"chiefDate\":\"" + chiefDate + "\",\"chiefStatus\":\"" + chiefStatus + "\",\"rwName\":\"" + rwName + "\",\"rwDate\":\"" + rwDate + "\",\"rwStatus\":\"" + rwStatus + "\"}";
    }
