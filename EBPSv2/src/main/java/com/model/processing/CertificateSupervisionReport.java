...
@Entity
@Table(name = "certificate_supervision_report")
public class CertificateSupervisionReport {
	...
	public String toString() {
		return "CertificateSupervisionReport [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate
