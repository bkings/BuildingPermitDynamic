...
@Entity
@Table(name = "notice_period_for_15_days")
public class NoticePeriodFor15Days implements Serializable {
    ...
    @Column(name = "ENTER_BY", columnDefinition = "VARCHAR(30)")
    ...
    @Column(name = "SER_STATUS", columnDefinition = "VARCHAR(1)")
    ...
    @Column(name = "ER_STATUS", columnDefinition = "VARCHAR(1)")
    ...
    @Column(name = "chief_STATUS", columnDefinition = "VARCHAR(1)")
    ...
    public String toString() {
        return "NoticePeriodFor15Days{" + "applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate + ", serName=" + serName + ", serDate=" + serDate + ", serStatus=" + serStatus + ", erName=" + erName + ", erDate=" + erDate + ", erStatus=" + erStatus + ", chiefName=" + chiefName + ", chiefDate=" + chiefDate + ", chiefStatus=" + chiefStatus + ", aminiName=" + aminiName + ", aminiDate=" + aminiDate + ", aminiStatus=" + aminiStatus + ", rwName=" + rwName + ", rwDate=" + rwDate + ", rwStatus=" + rwStatus + '}';
    }
