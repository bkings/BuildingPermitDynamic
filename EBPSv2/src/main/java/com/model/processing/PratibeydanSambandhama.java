...
@Entity
@Table(name = "pratibeydan_sambandhama")
public class PratibeydanSambandhama {
	...
	public String toString() {
		return "PratibeydanSambandhama [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate
