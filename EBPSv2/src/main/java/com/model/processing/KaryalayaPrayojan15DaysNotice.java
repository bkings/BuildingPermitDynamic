...
@Entity
@Table(name = "karyalaya_prayojan_15days_notice")
public class KaryalayaPrayojan15DaysNotice {
	...
	public String toString() {
		return "KaryalayaPrayojan15DaysNotice [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate
