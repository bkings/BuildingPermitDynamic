...
@Entity
@Table(name = "super_structure_supervision_report")
public class SuperStructureSupervisionReport {
	...
	public String toString() {
		return "SuperStructureSupervisionReport [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate="
