...
@Entity
@Table(name = "nirman_sampanna_praman_patra_and_dharauti_firta")
public class NirmanSampannaPramanPatraAndDharautiFirta {
	...
	public String toString() {
		return "NirmanSampannaPramanPatraAndDharautiFirta [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate="
				+ enterDate + ", aminiName=" + aminiName + ", aminiDate=" + aminiDate + ", aminiStatus=" + aminiStatus + ", serDate=" + serDate + ", serName="
				+ serName + ", erName=" + erName + ", erDate=" + erDate + ", erStatus=" + erStatus + ", serStatus=" + serStatus + ", chiefName=" + chiefName
				+ ", chiefDate=" + chiefDate + ", chiefStatus=" + chiefStatus + ", rwName=" + rwName + ", rwDate=" + rwDate + ", rwStatus=" + rwStatus
				+ ", eName=" + eName + ", eDate=" + eDate + ", eStatus=" + eStatus + ", fName=" + fName + ", fDate=" + fDate + ", fStatus=" + fStatus
				+ ", gName=" + gName + ", gDate=" + gDate + ", gStatus=" + gStatus + "]";
	}
