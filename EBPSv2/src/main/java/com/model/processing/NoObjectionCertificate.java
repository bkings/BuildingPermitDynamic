...
@Entity
@Table(name = "no_objection_certificate")
public class NoObjectionCertificate implements Serializable {
	...
	public String toString() {
		return "NoObjectionCertificate [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate
