...
@Entity
@Table(name = "suchana_taas_gari_muchulka")
public class SuchanaTaasGariMuchulka {
	...
	public String toString() {
		return "SuchanaTaasGariMuchulka [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate
