...
@Entity
@Table(name = "map_check_report")
public class MapCheckReport implements Serializable {
	...
	public String toString() {
		return "MapCheckReport{" + "applicationNo=" + applicationNo + ", enterBy=" + enterBy + ", enterDate=" + enterDate + ", serName=" + serName
				+ ", serDate=" + serDate + ", serStatus=" + serStatus + ", erName=" + erName + ", erDate=" + erDate + ", erStatus=" + erStatus + ", chiefName="
				+ chiefName + ", chiefDate=" + chiefDate + ", chiefStatus=" + chiefStatus + ", aminiName=" + aminiName + ", aminiDate=" + aminiDate
				+ ", aminiStatus=" + aminiStatus + ", rwName=" + rwName + ", rwDate=" + rwDate + ", rwStatus=" + rwStatus + '}';
	}
	...
	@Column(name = "SUB_DESIGNATION")
	private String subDesignation;
	@Column(name = "SUB_SIGNATURE")
