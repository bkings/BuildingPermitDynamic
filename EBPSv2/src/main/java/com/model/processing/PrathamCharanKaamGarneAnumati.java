...
@Entity
@Table(name = "pratham_charan_kaam_garne_anumati")
public class PrathamCharanKaamGarneAnumati {
	...
	public String toString() {
		return "PrathamCharanKaamGarneAnumati [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate
