...
@Entity
@Table(name = "high_rised_buildings")
public class HighRisedBuildings implements Serializable {
	...
	public String toString() {
		return "HighRisedBuildings [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate
