...
@Entity
@Table(name = "structure_design_b")
public class StructureDesignB implements java.io.Serializable {
    ...
    public String toString() {
        return "StructureDesignB{" + "applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", serName=" + serName + ", serDate=" + serDate + ", serStatus=" + serStatus + ", erName=" + erName + ", erDate=" + erDate + ", erStatus=" + erStatus + ", enterBy=" + enterBy + ", enterDate=" + enterDate + ", chiefName=" + chiefName + ", chiefDate=" + chiefDate + ", chiefStatus=" + chiefStatus + ", aminiName=" + aminiName + ", aminiDate=" + aminiDate + ", aminiStatus=" + aminiStatus + ", rwName=" + rwName + ", rwDate=" + rwDate + ", rwStatus=" + rwStatus + '}';
    }
