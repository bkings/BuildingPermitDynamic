...
@Entity
@Table(name = "notice_payment_application")
public class NoticePaymentApplication implements java.io.Serializable {
    ...
    @Column(name = "notice_till_date", updatable = false)
    @Temporal(TemporalType.DATE)
    private java.util.Date noticeTillDate;
    @Column(name = "notice_enter_by", updatable = false)
    private String noticeEnterBy;
    @Column(name = "notice_enter_date", updatable = false)
    @Temporal(TemporalType.DATE)
    private java.util.Date noticeEnterDate;
    @Column(name = "file_url1", updatable = false, columnDefinition = "VARCHAR")
    private String fileUrl1;
    @Column(name = "file_url2", updatable = false)
    ...
    public Date getNoticeTillDate() {
        return noticeTillDate;
    }

    public void setNoticeTillDate(Date noticeTillDate) {
        this.noticeTillDate = noticeTillDate;
    }

    public String getNoticeEnterBy() {
        return noticeEnterBy;
    }

    public void setNoticeEnterBy(String noticeEnterBy) {
        this.noticeEnterBy = noticeEnterBy;
    }

    public Date getNoticeEnterDate() {
        return noticeEnterDate;
    }

    public void setNoticeEnterDate(Date noticeEnterDate) {
        this.noticeEnterDate = noticeEnterDate;
    }
