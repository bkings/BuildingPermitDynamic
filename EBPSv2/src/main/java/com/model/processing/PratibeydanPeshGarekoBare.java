...
@Entity
@Table(name = "pratibeydan_pesh_gareko_bare")
public class PratibeydanPeshGarekoBare {
	...
	public String toString() {
		return "PratibeydanPeshGarekoBare [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate
