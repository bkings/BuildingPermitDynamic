...
@Entity
@Table(name = "naksa_pass_certificate")
public class NaksaPassCertificate {
	...
	public String toString() {
		return "NaksaPassCertificate [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate=" + enterDate
