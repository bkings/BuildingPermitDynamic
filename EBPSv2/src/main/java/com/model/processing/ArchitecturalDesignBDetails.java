...
@Entity
@Table(name = "architectural_design_b_details")
public class ArchitecturalDesignBDetails implements Serializable {
...
public ArchitecturalDesignBDetails() {
}
...
public void setRemark(String remark) {
    ...
    public String toString() {
        return "ArchitecturalDesignBDetails{" + "pk=" + pk + ", qty=" + qty + ", remark=" + remark + ", unit=" + unit + ", applicationNo=" + applicationNo + '}';
    }
