...
@Entity
@Table(name = "layout_tatha_sarjamin_gari_file_firta")
public class LayoutTathaSarjaminGariFileFirta {
	...
	public String toString() {
		return "LayoutTathaSarjaminGariFileFirta [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate="
