...
@Entity
@Table(name = "sansodhit_super_structure_ijajat_sambandhama")
public class SansodhitSuperStructureIjajatSambandhama {
	...
	public String toString() {
		return "SansodhitSuperStructureIjajatSambandhama [applicationNo=" + applicationNo + ", jsonData=" + jsonData + ", enterBy=" + enterBy + ", enterDate="
