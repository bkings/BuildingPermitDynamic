...
@Entity
@Table(name = "structure_design_c")
public class StructureDesignC implements Serializable {
    ...
    public String toString() {
        return "StructureDesignC{" + "applicationNo=" + applicationNo + ", enterBy=" + enterBy + ", enterDate=" + enterDate + ", serName=" + serName + ", serDate=" + serDate + ", serStatus=" + serStatus + ", erName=" + erName + ", erDate=" + erDate + ", erStatus=" + erStatus + ", chiefName=" + chiefName + ", chiefDate=" + chiefDate + ", chiefStatus=" + chiefStatus + ", aminiName=" + aminiName + ", aminiDate=" + aminiDate + ", aminiStatus=" + aminiStatus + ", rwName=" + rwName + ", rwDate=" + rwDate + ", rwStatus=" + rwStatus + ", jsonData=" + jsonData + '}';
    }
