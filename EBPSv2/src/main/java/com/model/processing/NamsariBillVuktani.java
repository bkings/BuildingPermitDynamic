...
@Entity
@Table(name = "namsari_bill_vuktani")
public class NamsariBillVuktani {
    ...
    public String toString() {
        return "{\" applicationNo\":\"" + applicationNo + "\",\" jsonData\":\"" + jsonData + "\",\" serName\":\"" + serName + "\",\" serDate\":\"" + serDate + "\",\" serStatus\":\"" + serStatus + "\",\" erName\":\"" + erName + "\",\" erDate\":\"" + erDate + "\",\" erStatus\":\"" + erStatus + "\",\" enterBy\":\"" + enterBy + "\",\" enterDate\":\"" + enterDate + "\",\" chiefName\":\"" + chiefName + "\",\" chiefDate\":\"" + chiefDate + "\",\" chiefStatus\":\"" + chiefStatus + "\",\" aminiName\":\"" + aminiName + "\",\" aminiDate\":\"" + aminiDate + "\",\" aminiStatus\":\"" + aminiStatus + "\",\" rwName\":\"" + rwName + "\",\" rwDate\":\"" + rwDate + "\",\" rwStatus\":\"" + rwStatus + "\"}";
    }
